...
BOT_TOKEN = environ.get('BOT_TOKEN', "7050693153:AAF3lQJQPct7hlY_7_AYweR0eUwpv1VGMxA")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002073497345').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://moviemarket1991:gurmeet1@cluster0.djfurgc.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'f41f7b9e3f180028795d15208bbb31d649d1283e')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/moviemarket_official/335')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Gurmeet!')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002085696400'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001396095544')).split()]
...
URL = "https://autofuilter-62528a80ce4b.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofuilter-62528a80ce4b.herokuapp.com/".format(FQDN, PORT)
SLEEP_THRESHOLD = int(environ.get('SLEEP_THRESHOLD', '60'))
WORKERS = int(environ.get('WORKERS', '4'))
SESSION_NAME = str(environ.get('SESSION_NAME', 'autofuilter'))
MULTI_CLIENT = False
name = str(environ.get('name', 'autofuilter'))
...
if HAS_SSL:
    URL = "https://autofuilter-62528a80ce4b.herokuapp.com/".format(FQDN)
else:
    URL = "https://autofuilter-62528a80ce4b.herokuapp.com/".format(FQDN)
