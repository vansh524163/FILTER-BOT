...
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/Moviesmarket360>𝐆𝐮𝐫𝐦𝐞𝐞𝐭</a>
 ‣ My best friend : <a href='tg://settings'>ᴛʜɪs ᴘᴇʀsᴏɴ</a> 
 ‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/Moviesmarket360'>𝐆𝐮𝐫𝐦𝐞𝐞𝐭 🇮🇳</a> 
 ‣ ʟɪʙʀᴀʀʏ : <a href='https://docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a> 
 ‣ ʟᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 3</a> 
 ‣ ᴅᴀᴛᴀ ʙᴀsᴇ : <a href='https://www.mongodb.com/'>ᴍᴏɴɢᴏ ᴅʙ</a> 
 ‣ ʙᴏᴛ sᴇʀᴠᴇʀ : <a href='https://render.com'>VPS</a> 
...
Where is source code? - <a href='https://t.me/𝐆𝐮𝐫𝐦𝐞𝐞𝐭/'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>
